    ...
    <div className="bg-gradient-to-tr from-green to-cream text-white min-h-screen bg-gradie flex items-center justify-center">
      <div className="w-[375px] sm:w-[30%] h-[45%] py-10 rounded shadow-2xl px-9 bg-gradient-to-tr from-cream to-green items-center flex flex-col">
        <div className="relative inline-block text-left">
          <button type="button" onClick={toggleDropdown} className="transition duration-300 ease-in-out inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 mb-3" id="menu-button" aria-expanded="true" aria-haspopup="true">Select a buckect To view the message  <FaAngleDown className="-mr-1 h-5 w-5 text-black" />
          </button>
          {isOpen && (
        ...
        <h1 className="text-3xl font-extrabold text-cream items-center">
          My SecretScribe 😅{" "}
        </h1>

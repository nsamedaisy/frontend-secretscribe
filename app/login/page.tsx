...
const Login = () => {
  ...
  return (
    <div className="bg-gradient-to-tr from-green to-cream text-black min-h-screen bg-gradie flex items-center justify-center">
      <div className="w-[375px] sm:w-[25%] h-[45%] bg- py-10 shadow-2xl px-9 bg-gradient-to-tr from-cream to-green">
        ...
        <section className="flex flex-col space-y-6 w-[60%] ml-[20%] mt-4 text-white font-extrabold font-lobster mb-4">
          <button
            onClick={() => signIn("google")}
            className="flex items-center gap-2 shadow-xl rounded-lg pl-3"
          >
